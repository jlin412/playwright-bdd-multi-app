...
export const test = base.extend<{
  ...
  nowPlayingPage: async ({ page }, use) => { await use(new NowPlayingPage(page)); },
  moviePage: async ({ page }, use) => { await use(new MoviePage(page)); },
  checkoutShowingPage: async ({ page }, use) => { await use(new CheckoutShowingPage(page)); },
  checkoutItemsPage: async ({ page }, use) => { await use(new CheckoutItemsPage(page)); },
  checkoutCartPage: async ({ page }, use) => { await use(new CheckoutCartPage(page)); },
  checkoutPaymentPage: async ({ page }, use) => { await use(new CheckoutPaymentPage(page)); },
  ...
  siteHealth: async ({ request }, use) => { await use(new SiteHealth(request)); },
});
