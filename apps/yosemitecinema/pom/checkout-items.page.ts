...
export class CheckoutItemsPage {
  ...
  async clickNextCart() {
    ...
    await this.page.waitForURL(/\/checkout\/cart/, { timeout: 30_000 });
  }
  ...
  @Then('the Food & Drink page cart summary should still show {int} ticket(s)')
  ...
  @Then('the modifier dialog should be open')
  ...
  @Then('the modifier dialog should not be open')
  ...
  @Then('the dialog total should show {string}')
  ...
  @Then('the food cart should contain {string}')
  ...
  @Then('the food cart should show at least {int} food item(s)')
