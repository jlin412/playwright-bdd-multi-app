...
export class MembershipPage {
  ...
  @Then('the membership prices should be displayed')
  ...
  @Then('the day pass option should be visible')
  async checkDayPass() { await this.expectDayPassVisible(); }

  @Then('the membership page should show at least one perk description')
  async checkFeatureItems() { await this.expectFeatureItemsVisible(); }

  @Then('the membership page should show the day pass description')
