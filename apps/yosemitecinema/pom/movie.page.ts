...
export class MoviePage {
  ...
  async clickFirstShowtime() {
    // Earlier showtimes become disabled once they pass / sell out, so pick the
    // first *enabled* showtime rather than blindly the first one.
    ...
    throw new Error('No enabled showtime button found on the movie detail page');
  }
