...
export class CheckoutShowingPage {
  ...
  @Then('the checkout page should show the four tabs Tickets, Food & Drink, Cart, and Payment')
  async checkAllTabs() {
  ...
  @Then('the continue as guest option should not be shown')
  ...
  @Then('the checkout page should offer a guest checkout option')
  ...
  @Then('the cart summary should show {int} ticket(s)')
